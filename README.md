...
4. Una vez ahí, introducimos el nombre de los archivos que hemos tenido que añadir en las respectivas carpetas, Drive Test, Crowdsourced y Celdas. Por último, añadimos el nombre del polígono y del operador en caso de que querramos filtrar los datos por esos valores. Y una vez hecho ejecutamos el resto de celdas hasta llegar a la parte de resultados.
